...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--method", type=str, help="Optional request method.")
    ...
    # If requesting a predicion to torchserve behind KServe,
    # KServeEnvelope (https://pytorch.org/serve/_modules/ts/torch_handler/request_envelope/kserve.html#KServeEnvelope)
    # automatically put the output in the predictions key
    if isinstance(predictions, dict) and "predictions" in predictions.keys():
