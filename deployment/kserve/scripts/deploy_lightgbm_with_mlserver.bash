...
service_name="lightgbm-v2-example"
s3_model_dir="s3://test-bucket/lightgbm-v2-example"
storage_uri="\"s3://test-bucket/lightgbm-v2-example\""
host_model_path="$tmp_kubeconfigs_path/lightgbm-v2-example"

mkdir -p "$host_model_path"

cp ../../../models/lightgbm_regressor/model.joblib $host_model_path/model.joblib
cp ../../mlserver/lightgbm_regressor/my_handler.py $host_model_path/my_handler.py
...
sed -e "s/{{ inference_service_resource_name }}/$service_name/g" \
    ...
    $templates_path/mlserver/lightgbm_v2.yaml \
    > $tmp_kubeconfigs_path/lightgbm-v2-isvc.yaml
...
deploy_inferenceservice_http $kube_api_url $cacert $cert $key "default" "$tmp_kubeconfigs_path/lightgbm-v2-isvc.yaml" "$service_name"
