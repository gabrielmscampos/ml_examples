...
deploy_inferenceservice_http $kube_api_url $cacert $cert $key "default" "$tmp_kubeconfigs_path/torchserve-v1-isvc.yaml" "$service_name"
...
if [ "$DELETE_AFTER_TESTING" == "true" ]; then
  ...
  kubectl delete -f $tmp_kubeconfigs_path/torchserve-v1-isvc.yaml
else
