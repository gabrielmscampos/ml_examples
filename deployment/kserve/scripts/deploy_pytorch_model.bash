...
service_name="pytorch-example"
s3_model_dir="s3://test-bucket/pytorch-example"
storage_uri="\"s3://test-bucket/pytorch-example\""
host_model_path="$tmp_kubeconfigs_path/pytorch-example"
